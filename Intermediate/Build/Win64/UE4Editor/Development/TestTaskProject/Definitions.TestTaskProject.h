...
#define UE_PROJECT_NAME TestTaskProject
#define UE_TARGET_NAME TestTaskProjectEditor
#define UE_MODULE_NAME "TestTaskProject"
...
#define TESTTASKPROJECT_API DLLEXPORT
